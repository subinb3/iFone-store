	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Main Store: iFone Store.<br>
				180-182 Church Street.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">799-447-1919</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@youriFone.com" class="email__addr">support@youriFone.com</a>
				</div>
			</div>
